...
function Navbar() {
  ...
  const numberOfCartItems = shoppingCartItems.reduce(
          ...
          <div className="menu-container__logo">
            ...
            {ROUT === 'customer' && (
              <div className="menu-container__map" onClick={mapOpen}>
                <img
                  src={mapIcon}
                  className="menu-container__map__icon"
                  alt=""
                />
                <p className="menu-container__map__text">
                  {deliveryLocation ? deliveryLocation : 'Balaiya Garden'}
                </p>
                <img
                  src={loginArrow}
