                ...
                <div className='Checkout__container'>
                    <div className='Checkout__form__block'>
                        <form className='Checkout__form'>
                            <div
                                className={openCheckoutItem !== 'one' ? 'Checkout__form__item' : 'Checkout__form__item Checkout__form__item--active'}
                                onClick={() => setOpenCheckoutItem('one')}>
                                <div className='Checkout__form__item__top'>
                                    <p className='Checkout__form__item__number'>1</p>
                                    <p className='Checkout__form__item__title'>Phone Number Verification</p>
                                </div>
                                <div className='Checkout__form__item__bottom'>
                                    <p className='Checkout__form__item__description'>We need your phone number so that
                                        we
                                        can update you about your order.</p>
                                    <input className="Checkout__form__inp"
                                           onChange={(e) => setPhoneNumber(e.target.value)}
                                           value={PhoneNumber} type='tel' placeholder='+45'/>
                                    <a href='#' className='next_style'>next >></a>
                                </div>
                            </div>
                            <div
                                className={openCheckoutItem !== 'two' ? 'Checkout__form__item' : 'Checkout__form__item Checkout__form__item--active'}
                                onClick={() => setOpenCheckoutItem('two')}>
                                <div className='Checkout__form__item__top'>
                                    <p className='Checkout__form__item__number'>2</p>
                                    <p className='Checkout__form__item__title'>Delivery Address</p>
                                </div>
                                <div className='Checkout__form__item__bottom delivery_body'>
                                    ...
                                    <a href='tel:+95 898 9898 989' className='Checkout__form__item__description'>
                                        <img src={mapPin} alt=""/>
                                        +95 898 9898 989
                                    </a>
                                    <a href='#' className='next_style'>next >></a>
                            ...
                            <div
                                className={openCheckoutItem !== 'three' ? 'Checkout__form__item' : 'Checkout__form__item Checkout__form__item--active'}
                                onClick={() => setOpenCheckoutItem('three')}>
                                <div className='Checkout__form__item__top'>
                                    <p className='Checkout__form__item__number'>3</p>
                                    <p className='Checkout__form__item__title'>Delivery Instruction</p>
                                </div>
                                <div className='Checkout__form__item__bottom'>
                                    <input className="Checkout__form__inp" type='tel'
                                           onChange={(e) => setDeliveryInstruction(e.target.value)}
                                           value={DeliveryInstruction} placeholder='Description'/>
                                    <a href='#' className='next_style'>next >></a>
                                </div>
                            </div>
                            <div
                                className={openCheckoutItem !== 'fore' ? 'Checkout__form__item' : 'Checkout__form__item Checkout__form__item--active__fore'}
                                ...
                                <div className='Checkout__form__item__bottom'>
                                    <p className='Checkout__form__item__description add_card'>+ ADD Card</p>
                                    <label className="Checkout__form__inp__block">
                                        ...
                                        Card Number</span>
                                        <input className="Checkout__form__inp Checkout__form__inp__big"
                        ...
                        <div className='Checkout__total'>
                            <div className="Checkout__total__item">
                                <div className="Checkout__total__line">
                                    ...
                                    <div className="Checkout__total__price">50 $</div>
                                </div>
                                <div className="Checkout__total__line">
                                    <div className="Checkout__total-text">Delivery</div>
                                    <div className="Checkout__total__price">5 $</div>
                                </div>
                            </div>
                            <div className="Checkout__total__item">
                                <div className="Checkout__total__line">
                                    <div className="Checkout__total-text">Order Total</div>
                                    <div className="Checkout__total__price">55 $</div>
                                </div>
                                <div className="Checkout__total__btn BestSavers__link">Place Order</div>
                            </div>
                        </div>
                    </div>
                    <div className='myCard'>
                        <h3 className="myCard__title">My Cart(2 items)</h3>
